 ...
 * @version $Id: JettyAdminServer.java, v 0.1 2018年4月24日 上午11:05:13 en.xuze@alipay.com Exp $
 */
public class JettyAdminServer implements AdminServer {
    ...
    public JettyAdminServer() throws AdminServerException {
        this(System.getProperty("zookeeper.admin.serverAddress", DEFAULT_ADDRESS), Integer.getInteger("zookeeper.admin.serverPort", DEFAULT_PORT),
                Integer.getInteger("zookeeper.admin.idleTimeout", DEFAULT_IDLE_TIMEOUT), System.getProperty("zookeeper.admin.commandURL", DEFAULT_COMMAND_URL));
    }
    ...
    //浏览器用http://127.0.0.1:8080/commands来访问
